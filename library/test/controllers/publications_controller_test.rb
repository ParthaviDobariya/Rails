...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { address: @publication.address, name: @publication.name, website: @publication.website } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { address: @publication.address, name: @publication.name, website: @publication.website } }
